...
const SLIDES = [
  {
    ...
    image: require("../assets/images/ChatGPT Image Mar 30, 2026, 11_43_06 AM.png"),
  },
  {
    id: "2",
    ...
    image: require("../assets/images/ChatGPT Image Apr 1, 2026, 08_47_35 PM.png"),
  },
  {
    id: "3",
    ...
    image: require("../assets/images/ChatGPT Image Mar 30, 2026, 11_59_06 AM.png"),
  },
];
      ...
      <ScrollView
        ...
        {SLIDES.map((slide, index) => (
          <View key={slide.id} style={[styles.slide, { width, height }]}>
            ...
            />
            <LinearGradient
              colors={["transparent", "#f3f4d4", "#f3f4d4"]}
