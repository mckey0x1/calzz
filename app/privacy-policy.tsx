...
const SECTIONS = [
  ...
  },
  {
    ...
    content:
      "Your data is used to provide personalized nutrition tracking, AI-powered insights, calorie calculations, and progress analytics. We use a secure database to safely store and sync your data across devices. We do not sell your personal information to third parties.",
  },
  {
    title: "Data Storage & Security",
    content:
      "Your data is stored securely using industry-standard database infrastructure with high-level encryption. Authentication is handled through secure OAuth providers. We implement appropriate technical and organizational measures to protect your personal data against unauthorized access.",
  },
  {
    title: "Third-Party Services",
    content:
      "We use the following third-party services:\n\n- Authentication & Data storage providers\n- RevenueCat (subscription management)\n- Apple App Store / Google Play Store (payment processing)\n- Expo (app framework and services)\n\nEach service has its own privacy policy governing data handling.",
  },
  {
    title: "Subscriptions & Payments",
    content:
      "When you purchase a subscription via the App Store or Google Play Store, your billing and financial information is processed directly by the respective store. We utilize RevenueCat to manage subscription status and verification. We do not store your credit card or billing details on our own servers.",
  },
  {
    title: "Your Rights",
    content:
  ...
  },
  {
    ...
    content:
      "This app is not intended for children under the age of 5. We do not knowingly collect personal information from children. If you believe a child has provided us with personal data, please contact us for immediate removal.",
  },
  {
