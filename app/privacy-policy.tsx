    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        <View style={[styles.badge, { backgroundColor: colors.tint + "15" }]}>
          ...
          <Text style={[styles.badgeText, { color: colors.tint }]}>Your data is protected</Text>
        </View>
        ...
        <Text style={[styles.intro, { color: colors.textSecondary }]}>
          NutriAI ("we", "our", "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you use our mobile application.
        </Text>
