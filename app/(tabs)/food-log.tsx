      ...
      <ScrollView
        ...
        <View style={[styles.heroCard, { backgroundColor: "#fff" }]}>
          <View style={styles.heroLeft}>
            <Text style={styles.heroNumber}>{Math.round(caloriesLeft)}</Text>
        ...
        <View style={styles.macrosRow}>
          ...
          <View style={[styles.macroCard, { backgroundColor: "#fff" }]}>
            ...
            <Text style={styles.macroVal}>{Math.round(proteinLeft)}g</Text>
          ...
          <View style={[styles.macroCard, { backgroundColor: "#fff" }]}>
            ...
            <Text style={styles.macroVal}>{Math.round(carbsLeft)}g</Text>
          ...
          <View style={[styles.macroCard, { backgroundColor: "#fff" }]}>
            ...
            <Text style={styles.macroVal}>{Math.round(fatLeft)}g</Text>
